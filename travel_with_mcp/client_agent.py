...
async def main() -> None:
    ...
    response = await agent.ainvoke(
        {"messages": [HumanMessage(content="Can you find me some flights to Lisbon? I'm solo, whithout children. I live in Paris. I want to go westerday 23 setpember for 4 days.")]},
        config=config,
    )
